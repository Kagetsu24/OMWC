...
resultsRouter.get('/qualifiers', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const qualifier = yield Round_1.Round.findOne({
        where: {
            isQualifier: true,
            resultsAt: typeorm_1.LessThanOrEqual(new Date()),
        },
        relations: [
            'matches',
            'matches.submissions',
    ...
    const judges = (_c = (_b = (_a = qualifier === null || qualifier === void 0 ? void 0 : qualifier.matches) === null || _a === void 0 ? void 0 : _a[0].submissions) === null || _b === void 0 ? void 0 : _b[0].qualifierJudging) === null || _c === void 0 ? void 0 : _c.map(j => j.judge);
    return ctx.body = {
        criterias,
        qualifier,
        judges,
